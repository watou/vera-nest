...
* Add "where" location info to device names (e.g., Hallway, Den, Basement, etc.) on device creation if specified ([#33](https://github.com/watou/vera-nest/issues/33))
...
* Move the "Home/Away" device from DEVICE_CATEGORY_SWITCH (3) to DEVICE_CATEGORY_HVAC (5) ([#29](https://github.com/watou/vera-nest/issues/29))
